...
#                                  })]
    ...
    def print_report(self):
        if not self.env.user.has_group('product_barcode_qweb.group_3barcode_labels'):
        ...
        #return self.env['report'].get_action([], 'product_barcode_qweb.report_product_trbarcode', data=datas)
        return self.env.ref('product_barcode_qweb.product_barcode_qweb_11cm').report_action(self, data=datas)
